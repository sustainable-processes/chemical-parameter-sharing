...
super_class_fgi_training:
	python -m gao_condition_prediction.condition_prediction --train_data_path="data/super_class_fgi_train.parquet" --test_data_path="data/super_class_fgi_test.parquet" --output_folder_path="models/super_class_fgi"  --train_fraction=1 --train_val_split=0.8 --overwrite=False --epochs=100 --evaluate_on_test_data=True --early_stopping_patience=100 --wandb_entity=$(WANDB_ENTITY)

super_class_reductions_training:
	python -m gao_condition_prediction.condition_prediction --train_data_path="data/super_class_reductions_train.parquet" --test_data_path="data/super_class_reductions_test.parquet" --output_folder_path="models/super_class_reductions"  --train_fraction=1 --train_val_split=0.8 --overwrite=False --epochs=100 --evaluate_on_test_data=True --early_stopping_patience=100 --wandb_entity=$(WANDB_ENTITY)
